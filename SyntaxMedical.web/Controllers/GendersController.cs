...
namespace SyntaxMedical.web.Controllers
{
    public class GendersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GenderName,ShortName")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GenderName,ShortName")] Gender gender)
        {
            if (id != gender.Id)
            {
                return NotFound();
